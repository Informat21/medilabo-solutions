...
public class RiskController {
    ...
    public RiskLevel assessRisk(@PathVariable String id) {
        ...
        PatientDTO patient = restTemplate.getForObject("http://localhost:8081/patients/" + id, PatientDTO.class);

        // 2️⃣ Récupérer notes depuis notes-service
        NoteDTO[] notesArray = restTemplate.getForObject("http://localhost:8083/notes/patient/" + id, NoteDTO[].class);
